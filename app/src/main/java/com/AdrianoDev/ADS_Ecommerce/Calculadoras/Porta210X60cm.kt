...
import com.AdrianoDev.ADS_Ecommerce.databinding.ActivityPorta210x60cmBinding
import com.AdrianoDev.ADS_Ecommerce.model.listadeprodutos

class Porta210X60cm : AppCompatActivity() {

    private lateinit var binding: ActivityPorta210x60cmBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityPorta210x60cmBinding.inflate(layoutInflater)
    ...
    private fun calculadoraPISO() {


        val mtpiso = binding.editTextNumber.value


        val resultado = mtpiso.toString().toDouble() * 399.00
