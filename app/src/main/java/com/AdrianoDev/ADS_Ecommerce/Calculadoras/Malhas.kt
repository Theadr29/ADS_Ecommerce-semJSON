...
import com.AdrianoDev.ADS_Ecommerce.databinding.ActivityMalhasBinding
import com.AdrianoDev.ADS_Ecommerce.model.listadeprodutos


class Malhas : AppCompatActivity() {
    private lateinit var preferences: SharedPreferences
    private lateinit var binding: ActivityMalhasBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMalhasBinding.inflate(layoutInflater)
