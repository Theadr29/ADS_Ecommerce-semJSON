...
import com.AdrianoDev.ADS_Ecommerce.databinding.ActivityJanela100x100Binding

class Janela100x100cm : AppCompatActivity() {

    private lateinit var binding: ActivityJanela100x100Binding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)


        binding = ActivityJanela100x100Binding.inflate(layoutInflater)
    ...
    private fun calculadora() {
        ...
        val resultado = mtpiso.toString().toDouble() * 149.00
