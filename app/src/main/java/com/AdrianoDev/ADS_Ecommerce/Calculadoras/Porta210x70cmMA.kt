...
import com.AdrianoDev.ADS_Ecommerce.databinding.ActivityPorta210x70cmMaBinding

class Porta210x70cmMA : AppCompatActivity() {

    private lateinit var binding: ActivityPorta210x70cmMaBinding


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityPorta210x70cmMaBinding.inflate(layoutInflater)
    ...
    private fun calculadora() {
        ...
        val resultado = mtpiso.toString().toDouble() * 120.00
