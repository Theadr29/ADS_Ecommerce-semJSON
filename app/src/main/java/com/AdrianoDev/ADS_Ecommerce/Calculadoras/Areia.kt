...
import com.AdrianoDev.ADS_Ecommerce.databinding.ActivityAreiaBinding

import com.AdrianoDev.ADS_Ecommerce.model.listadeprodutos


class Areia : AppCompatActivity() {

    private lateinit var preferences: SharedPreferences
    private lateinit var binding: ActivityAreiaBinding
    private val decimalValues = floatArrayOf(0.0f, 0.5f, 1.0F, 1.5f, 2.0f, 2.5f, 3.0f, 3.5f, 4.0f, 4.5f)

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityAreiaBinding.inflate(layoutInflater)
    ...
    private fun calculadora() {
        ...
        val resultado = selectedValue * 120.00

        binding.resultadofinal.text = String.format("%.1f", resultado)
