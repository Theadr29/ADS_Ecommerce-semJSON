...
import com.AdrianoDev.ADS_Ecommerce.databinding.ActivityIsoporBinding
import com.AdrianoDev.ADS_Ecommerce.model.listadeprodutos


class Isopor : AppCompatActivity() {
    private lateinit var preferences: SharedPreferences
    private lateinit var binding: ActivityIsoporBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityIsoporBinding.inflate(layoutInflater)
    ...
    private fun calculadora() {
        ...
        val resultado = mtpiso.toString().toDouble() * 8.00
