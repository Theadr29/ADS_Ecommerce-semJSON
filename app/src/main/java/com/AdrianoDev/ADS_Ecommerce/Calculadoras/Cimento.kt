...
import com.AdrianoDev.ADS_Ecommerce.databinding.ActivityCimentoBinding
import com.AdrianoDev.ADS_Ecommerce.model.listadeprodutos

class Cimento : AppCompatActivity() {

    private lateinit var preferences: SharedPreferences
    private lateinit var binding: ActivityCimentoBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCimentoBinding.inflate(layoutInflater)
