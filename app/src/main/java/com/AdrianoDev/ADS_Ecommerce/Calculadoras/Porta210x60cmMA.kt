...
import com.AdrianoDev.ADS_Ecommerce.databinding.ActivityPorta210x60cmMaBinding

class Porta210x60cmMA : AppCompatActivity() {

    private lateinit var binding: ActivityPorta210x60cmMaBinding


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityPorta210x60cmMaBinding.inflate(layoutInflater)
    ...
    private fun calculadora() {
        ...
        val resultado = mtpiso.toString().toDouble() * 100.00
