...
import com.AdrianoDev.ADS_Ecommerce.databinding.ActivityLajesBinding
import com.AdrianoDev.ADS_Ecommerce.model.listadeprodutos


class Lajes : AppCompatActivity() {
    private lateinit var preferences: SharedPreferences
    private lateinit var binding: ActivityLajesBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityLajesBinding.inflate(layoutInflater)
    ...
    private fun calculadora() {
        ...
        val resultado = mtpiso.toString().toDouble() * 46.00
