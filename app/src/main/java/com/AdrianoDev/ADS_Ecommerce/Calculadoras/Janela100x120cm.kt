...
import com.AdrianoDev.ADS_Ecommerce.databinding.ActivityJanela100x120Binding

class Janela100x120cm : AppCompatActivity() {

    private lateinit var binding: ActivityJanela100x120Binding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityJanela100x120Binding.inflate(layoutInflater)
    ...
    private fun calculadora() {
        ...
        val resultado = mtpiso.toString().toDouble() * 169.00
