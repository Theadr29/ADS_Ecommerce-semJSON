...
import com.AdrianoDev.ADS_Ecommerce.databinding.ActivityPorta210x70Binding

class Porta210x70cm : AppCompatActivity() {

    private lateinit var binding: ActivityPorta210x70Binding


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityPorta210x70Binding.inflate(layoutInflater)
